...
QT_MOC_LITERAL(3, 13, 21) // "on_buttonBox_accepted"

    },
    "Dialog\0load\0\0on_buttonBox_accepted"
};
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog::load)) {
                *result = 0;
                return;
            }
        }
