/****************************************************************************
** Meta object code from reading C++ file 'exit_dialog.h'
**
...
#include "../../qt_3/exit_dialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'exit_dialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 18, 21) // "on_buttonBox_accepted"
    ...
    "Exit_Dialog\0save\0\0on_buttonBox_accepted"
};
...
void Exit_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Exit_Dialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Exit_Dialog::save)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Exit_Dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Exit_Dialog.data,
      qt_meta_data_Exit_Dialog,  qt_static_metacall, nullptr, nullptr}
};
